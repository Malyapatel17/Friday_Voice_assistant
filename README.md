...
- 🎤 **Fast & Accurate**: Vosk offline speech recognition
...
- ~50MB disk space for Vosk speech model (downloaded once)
...
Download the English speech model (~50MB):

1. Go to https://alphacephei.com/vosk/models
2. Download **vosk-model-en-us-0.22** (fastest)
3. Extract it and rename the folder to `model`
4. Place the `model` folder in the same directory as `clap_launcher.py`

**Your directory should look like:**
```
wake-up/
├── clap_launcher.py
├── model/  ← Extracted model folder
├── requirements.txt
└── README.md
```
...
With Vosk, you can use **any word** as your wake word! The speech recognition works with common English words and phrases.
...
**Note:** Make sure to speak clearly for best recognition results.
...
Make sure you've downloaded and extracted the model folder:
1. Download from https://alphacephei.com/vosk/models
2. Extract **vosk-model-en-us-0.22** 
3. Rename folder to `model`
4. Place it in the same directory as `clap_launcher.py`
...
2. **Wake Word**: Vosk continuously listens for your wake word using offline speech recognition
...
- Open-source Vosk library with no telemetry
